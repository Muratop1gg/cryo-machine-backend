...
"stats": {
    "patient_hoist": number //0 - стоп	1 - движение вверх 2 - движение вниз 3 - авария
    "pipe_hoist": number //0 - стоп	1 - движение вверх 2 - движение вниз 3 - авария
    "steam": number //0 - стоп 1 - включение 2 - работа 3 - остановка 4 - авария
    "charger": number //0 - стоп 1 - работа 2 - авария
    "heater": number // 0 - стоп 1 - работа 2 - авария
    "exhaust": number // 0 - стоп 1 - включение 2 - работа 3 - остановка 4 - авария
  }
```
